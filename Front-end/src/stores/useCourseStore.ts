...
export const useCourseStore = create<CourseState>((set, get) => ({
  ...
  fetchCourses: async () => {
    ...
    try {
      ...
      set({
        error: getErrorDetail(error, 'Failed to fetch courses'),
        isLoading: false,
      });
    }
  },
  ...
  fetchCourse: async (id: number) => {
    ...
    try {
      ...
      set({
        error: getErrorDetail(error, 'Failed to fetch course details'),
        isLoading: false,
      });
    }
  },
  ...
  createCourse: async (data: CreateCourseData) => {
    ...
    try {
      ...
      set({
        error: getErrorDetail(error, 'Failed to create course'),
        isLoading: false,
      });
      throw error;
    }
  ...
  updateCourse: async (id: number, data: UpdateCourseData) => {
    ...
    try {
      ...
      set({
        error: getErrorDetail(error, 'Failed to update course'),
        isLoading: false,
      });
      throw error;
    }
  ...
  deleteCourse: async (id: number) => {
    ...
    try {
      ...
      set({
        error: getErrorDetail(error, 'Failed to delete course'),
        isLoading: false,
      });
      throw error;
    }
  ...
  createKnowledgePoint: async (
    ...
    try {
      ...
      set({
        error: getErrorDetail(error, 'Failed to create knowledge point'),
        isLoading: false,
      });
      throw error;
    }
  ...
  updateKnowledgePoint: async (
    ...
    try {
      ...
      set({
        error: getErrorDetail(error, 'Failed to update knowledge point'),
        isLoading: false,
      });
      throw error;
    }
  ...
  deleteKnowledgePoint: async (courseId: number, kpId: number) => {
    ...
    try {
      ...
      set({
        error: getErrorDetail(error, 'Failed to delete knowledge point'),
        isLoading: false,
      });
      throw error;
    }
