...
export const courseService = {
    ...
    async getKnowledgePoints(courseId: number): Promise<KnowledgePoint[]> {
        const response = await api.get<KnowledgePoint[]>(`/courses/${courseId}/knowledge-points`);
        return response.data;
    },
     ...
     */
    async createKnowledgePoint(courseId: number, data: CreateKnowledgePointData): Promise<KnowledgePoint> {
        const response = await api.post<KnowledgePoint>(`/courses/${courseId}/knowledge-points`, data);
        return response.data;
    },
     ...
     */
    async updateKnowledgePoint(courseId: number, kpId: number, data: UpdateKnowledgePointData): Promise<KnowledgePoint> {
        const response = await api.put<KnowledgePoint>(`/courses/${courseId}/knowledge-points/${kpId}`, data);
        return response.data;
    },
