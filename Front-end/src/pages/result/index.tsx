...
export const ResultPage: React.FC = () => {
  ...
  const handleSaveToBank = useCallback(async () => {
    console.log('handleSaveToBank 被调用', {
      quiz,
  ...
  return (
    <div className='max-w-4xl mx-auto'>
      {/* 成绩概览卡片 */}
      <div
        className={`bg-white rounded-lg shadow-sm border p-6 mb-6 ${getScoreColorClass()}`}
      >
