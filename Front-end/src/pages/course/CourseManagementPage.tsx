...
// Modal 状态类型
type ModalType = 'createCourse' | 'editCourse' | 'addPoint' | 'editPoint' | 'deleteCourse' | 'deletePoint' | null;
        ...
        return (
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    <Button variant="ghost" onClick={clearCurrentCourse} icon={<ArrowLeft className="w-4 h-4" />}>
                        返回列表
                    </Button>
                    <div>
                        <h2 className="text-xl font-bold text-gray-900">{currentCourse.name}</h2>
